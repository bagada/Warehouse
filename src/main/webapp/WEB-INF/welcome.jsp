...
<html auto-config="true" use-expressions="true">

<head>
	<meta charset="utf-8"/>
	<title>Poliformas</title>
...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="index.html">Website User</a></h1>
			<h2 class="section_title">Login</h2><div class="btn_view_site"><a href="http://www.medialoot.com">View Site</a></div>
		</hgroup>
	...
	<aside id="sidebar" class="column">
		...
		<h3>Users</h3>
		<ul class="toggle">
			<li class="icn_add_user"><a href="<c:url value="/registerUser" />">Add New User</a></li>
	...
	<section id="main" class="column">
			...
			<h4 class="alert_info"> <a href="<c:url value="/j_spring_security_logout"/>">Logout</a> </h4>
